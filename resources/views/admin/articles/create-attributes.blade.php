...
<div class="form-group">
    <label for="articleAttributeQuantity">Quantity <span class="text text-danger">*</span></label>
    <input type="text" name="articleAttributeQuantity" id="articleAttributeQuantity" class="form-control" placeholder="Set quantity" disabled>
</div>
<div class="form-group">
    <label for="articleAttributePrice">Price</label>
    <div class="input-group">
        <span class="input-group-addon">{{ config('cart.currency') }}</span>
        <input type="text" name="articleAttributePrice" id="articleAttributePrice" class="form-control" placeholder="Price" disabled>
    </div>
</div>
<div class="form-group">
